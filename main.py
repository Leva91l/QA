...
# 6 студентов:
john = Student(fake.first_name(), fake.last_name(), 20)
peter = Student(fake.first_name(), fake.last_name(), 25)
sandra = Student(fake.first_name(), fake.last_name(), 23)
james = Student(fake.first_name(), fake.last_name(), 25)
liza = Student(fake.first_name(), fake.last_name(), 24)
nick = Student(fake.first_name(), fake.last_name(), 26)
...
# 3 учителя:
jack = Teacher(fake.first_name(), fake.last_name(), '40', 'math')
katya = Teacher(fake.first_name(), fake.last_name(), '25', 'russian')
dasha = Teacher(fake.first_name(), fake.last_name(), '25', 'biology')
